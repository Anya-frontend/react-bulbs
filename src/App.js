    ...
    <div className="wrapper clear">
      <header>
        <div className="leftHeader">
          <img width={40} height={60} src="./img/bulb.svg" />
...
"
      ...
      <div className="content">
        ...
        <div className="bulbs">
          ...
          <div className="card">
            <img width={140} height={120} src="/img/bulbs/2.jpg" alt="bulbs" />
            <h5>
              Philips Dimmable 4.5W 2000K Vintage T10 Filament LED Bulb, Title
              20 Compliant, Outdoor Rated
            </h5>
            <div className="cardBottom">
              <div className="cardPrice">
                <span>Price</span>
          ...
          <div className="card">
            <img width={140} height={120} src="/img/bulbs/3.jpg" alt="bulbs" />
            <h5>Bulbrite 25W 120V T6 Nostalgic Decorative Bulb, E12 Base</h5>
            <div className="cardBottom">
              <div className="cardPrice">
                <span>Price</span>
                <b>$25</b>
          ...
          <div className="card">
            <img width={140} height={120} src="/img/bulbs/4.jpg" alt="bulbs" />
            <h5>Bulbrite 60W 120V Grand Nostalgic Decorative Bulb, E26 Base</h5>
            <div className="cardBottom">
              <div className="cardPrice">
                <span>Price</span>
                <b>$25</b>
          ...
          <div className="card">
            <img width={140} height={120} src="/img/bulbs/5.jpg" alt="bulbs" />
            <h5> Satco 40W 120V G25 Amber Filament, Nostalgic E26 Base</h5>
            <div className="cardBottom">
              <div className="cardPrice">
                <span>Price</span>
                <b>$25</b>
